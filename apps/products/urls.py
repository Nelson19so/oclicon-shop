...
from .views import ProductDetailView, RandomProductListView, FilteredProductListView, ComparisonPageView, AddToComparisonView

urlpatterns = [
    # shop url conf
    path('shop/', RandomProductListView.as_view(), name="random_product"),
